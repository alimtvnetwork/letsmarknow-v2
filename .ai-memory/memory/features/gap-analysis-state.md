...
| Cumulative rescore v2 | Per-domain math baseline → 100/100/100 across all 21 domains | `23-audits/audit-2026-04-19-rescore-delta-v2.md` |
...
11 🔴 hard conflicts from `23-audits/audit-2026-04-19-m-gaps.md` resolved:

> **Path note (2026-04-19 evening):** All audit files moved into `02-spec/21-app/23-audits/`. References elsewhere in this memory file that show bare `audit-2026-04-19-*.md` paths now resolve to `02-spec/21-app/23-audits/<file>`.
