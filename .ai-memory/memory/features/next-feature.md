...
**Source spec:** `02-spec/21-app/07-features/17-next-queue.md`
**Data model:** `02-spec/21-app/02-data-model/12-next-item.md` + `03-collection.md` (kind enum + Invariants 10–13)
**UI:** `02-spec/21-app/04-extension/04-popup.md §14` (popup body region)
**Glossary:** `02-spec/21-app/00-overview/02-glossary.md` "Next" section
