...
**Source of truth:** `02-spec/21-app/13-spec-issues/02-current-issues.md`
**Phase plan:** `02-spec/21-app/13-spec-issues/03-phase-plan.md`
**Closed archive:** `02-spec/21-app/13-spec-issues/04-closed-issues.md`
**Naming rules:** `02-spec/21-app/13-spec-issues/01-naming-conventions.md`
