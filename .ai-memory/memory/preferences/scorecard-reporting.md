...
**Rule:** Every session that touches `02-spec/21-app/` (audits, sweeps, drift fixes, new findings, SI work, drain batches) MUST end the response with the **Implementability Scorecard** block, BEFORE the "Remaining tasks" section.
...
**Source of truth:** `02-spec/21-app/23-audits/audit-2026-04-29-ai-readiness-score-v2.md` §1 (baseline) and §3 (gating checks).
