...
> **Path note (2026-04-19 evening):** All audit files moved into `spec/21-app/23-audits/`. References elsewhere in this memory file that show bare `audit-2026-04-19-*.md` paths now resolve to `spec/21-app/23-audits/<file>`.
