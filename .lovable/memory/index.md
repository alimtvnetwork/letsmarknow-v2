...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — **1 open / 32 closed.** SI-029 (S2, blocked on legal counsel). Session 62 (2026-04-29): drained SH2+SH4+SH7 from `audit-2026-04-29-sharing-collab-sweep.md` (3 of 9 closed). All in `08-sharing-collab/00-overview.md`: W-4 channel-naming contradiction killed; v2 design-note marked ⚠️; §1 bullet 10 added for share URL surfaces. Remaining: **SH1+SH8 (S1 launch-blocker — matrix missing `guest`/`system` roles)**, SH3, SH5, SH6, SH9. 17/17 linters green. Score 100/100.
