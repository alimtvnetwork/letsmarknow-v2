...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 1 open (SI-026 forward-ref backlog: **15 remaining**, was 21 at S38) / 31 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: **17/19**, all 17 fully green (1886 backticked refs across 300 files). Session 39 drained 6 SI-026 entries: 3 phase-roadmap paths requalified in `00-overview/05-browser-scope.md` §2.7, plus 3 release-ops stubs authored as `04-extension/17-store-listing.md`, `18-firefox-port.md`, `19-staging-seed.md` (extension folder grew 16→19 slots; `00-overview.md` table updated). Remaining: 4 src-dependent linters (blocked on lifting no-implementation-mode), Toby spec re-paste (6 ergonomics defaults), SI-026 closure (15 planned files to author). Last activity: Session 39, 2026-04-29.
