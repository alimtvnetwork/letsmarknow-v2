...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — **1 open / 32 closed.** SI-029 (S2, privacy-pack stub expansion, blocked on legal counsel). Session 61 (2026-04-29): opened `audit-2026-04-29-sharing-collab-sweep.md` — 9 findings (1×S1 SH1: permissions-matrix missing `guest`+`system` roles → RLS launch-blocker; 4×S2 SH2/SH3/SH4/SH5; 4×S3). Prior data-model audit fully closed (9/9). 17/17 linters green. Score 100/100.
