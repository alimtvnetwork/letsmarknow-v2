...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 0 open / 30 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: 9/19 — all green. **W-issue trio COMPLETE** (W-6 ✅ + W-10 ✅ + W-13 ✅) + **W-4 channel-syntax** ✅ Session 26. Real drift catch rate: 3/9 (33%). Allowlists: 4 files, all validated by `allowlist-discipline`. Architectural pattern: scope-narrowing > allowlists when §2.1.1 specifies a scope (proven Sessions 25 + 26, 0 allowlists needed for both). Last activity: Session 26, 2026-04-29.
