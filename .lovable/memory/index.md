...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 0 open / 30 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: 7/19 — all green (`endpoint-counts`, `audit-cadence`, `naming-convention`, `allowlist-discipline`, `folder-overview`, `money-units`, `sku-naming`). Real drift catch rate: 3/7 (43%) — SI-025 (12 phantom endpoint rows), S22 heading drift (3 files), SI-026 (`discount_minor` W-10 survivor). W-issue trio status: W-6 ✅, W-10 ✅, W-13 ⏳. Allowlists: 4 files, all validated by `allowlist-discipline`. Last activity: Session 24, 2026-04-29.
