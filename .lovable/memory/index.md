...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — **1 open / 32 closed.** SI-029 (S2, privacy-pack stub expansion, blocked on legal counsel). Session 60 (2026-04-29): drained D3+D6+D7+D8+D9 from `audit-2026-04-29-data-model-sweep.md`. **Audit fully closed 9/9.** Tag scope sentence now names Collection/Group/Item; tag no-soft-delete design documented; Item lifecycle clarifies empty Groups are valid. 17/17 linters green. Score 100/100.
