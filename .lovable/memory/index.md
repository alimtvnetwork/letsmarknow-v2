...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — **1 SI open / 32 SIs closed.** Session 69 (2026-04-29): **security-privacy audit fully closed (10/10).** SP7: removed RS256 JWT fallback in `03-encryption.md §4`. SP8: collapsed sub-processor table triplication — `02-data-handling.md §7` + `04-gdpr-ccpa.md §5` now reference `07-privacy-policy.md §3` only. SP9: residency table — UK/Switzerland served from EU; Canada removed. SP10: TLS 1.2 sunset → concrete `2026-12-31`. Only SI-029 remains (blocked on legal counsel). 17/17 linters green. Score 100/100.
