...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 1 open (SI-026 forward-ref backlog: 18 remaining, was 21) / 31 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: **17/19**, all 17 fully green (1852 backticked refs across 297 files). Session 39 drained 3 SI-026 entries by qualifying phase-roadmap paths in `00-overview/05-browser-scope.md` §2.7 (`02-phase-1-v1.md` → `20-roadmap/02-phase-1-v1.md`, etc.). Remaining: 4 src-dependent linters (blocked on lifting no-implementation-mode), Toby spec re-paste (6 ergonomics defaults), SI-026 closure (18 planned files to author or convert to `(planned)` prose). Last activity: Session 39, 2026-04-29.
