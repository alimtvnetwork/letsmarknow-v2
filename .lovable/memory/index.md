...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 0 open / 31 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: **12/19 — `next-singleton-invariants` added Session 29 alongside the new Next feature spec**. All green. W-issue trio + W-4 channels + link-check (W-5) + pricing-source (W-3) all done. Real drift catch rate: 4/12 (33%; new linter is preventive). Allowlists: 7 files, all validated by `allowlist-discipline`. Last activity: Session 29, 2026-04-29.
