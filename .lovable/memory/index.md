...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 0 open / 30 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: 8/19 — all green (`endpoint-counts`, `audit-cadence`, `naming-convention`, `allowlist-discipline`, `folder-overview`, `money-units`, `sku-naming`, `pagination-param`). **W-issue trio COMPLETE Session 25** (W-6 ✅ + W-10 ✅ + W-13 ✅). Real drift catch rate: 3/8 (37.5%). Allowlists: 4 files, all validated by `allowlist-discipline`. Architectural pattern established: scope-narrowing > allowlists when §2.1.1 specifies a scope. Last activity: Session 25, 2026-04-29.
