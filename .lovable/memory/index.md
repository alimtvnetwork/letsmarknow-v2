...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — Live open/closed counts. Currently 0 open / 31 closed. Score 100/100. Endpoint inventory: 171 canonical declarations. Linters shipped: **16/19**, all 16 fully green. Session 37 wrote milestone re-audit `23-audits/audit-2026-04-29-full-green-milestone.md` (16/16 clean, 0 open SIs, 296 spec files, 171/171 endpoints) and extended `23-audits/readme.md` reading-order with the four 2026-04-29 surge audits + the new milestone audit. Remaining: 4 src-dependent linters (blocked on lifting no-implementation-mode), Toby spec re-paste (6 ergonomics defaults), backticked-path-resolution linter (Session 36 gap, deferred). Last activity: Session 37, 2026-04-29.
