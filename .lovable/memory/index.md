...
## Memories
- [Spec issue tracker](mem://features/spec-issue-tracker.md) — **1 SI open / 0 audit findings open / 44 SIs closed.** Session 94 (2026-04-29): **drained HU4 + HU5 (S3 polish batch); audit-91 fully closed (5/5).** `03-conflict-resolution.md §15` Idempotency-Key row now cites `03-api-endpoints/01-conventions.md §6`. `01-event-log.md §8` history endpoints now cross-ref `03-api-endpoints/14-history.md §10`. SI-029 still blocked on legal counsel. Scorecard 100/100/100.
