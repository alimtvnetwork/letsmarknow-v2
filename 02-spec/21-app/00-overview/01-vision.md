...
- ❌ AI summarization of pages (deferred to v2 — see `20-roadmap/04-phase-3-mindmap-ai.md`).
- ❌ **Any browser other than Google Chrome at v1 launch.** Edge / Brave / Arc / Opera / Firefox / Safari are all postponed to Phase 4. See `00-overview/05-browser-scope.md`.
