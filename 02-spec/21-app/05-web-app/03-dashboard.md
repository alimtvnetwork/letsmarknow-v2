...
> The base layout (cards, view modes, drag-and-drop, bulk select, hover-to-jump, right-click menus) is specified in `04-extension/05-new-tab.md`. This file documents the **web-app deltas**.
