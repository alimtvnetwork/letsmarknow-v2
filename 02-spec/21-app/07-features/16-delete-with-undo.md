...
> 📌 **Pointer file.** Soft-delete grammar lives in `01-information-architecture/01-hierarchy.md §3.5`. Undo/redo mechanics live in `12-history-undo/02-undo-redo.md`. Trash UI lives in `05-web-app/09-trash.md`.
...
3. Surfaces a **toast** with "Undo" CTA (5 s timeout) — see `06-ui-ux/11-feedback.md`.
4. After 30 d in trash → background job hard-deletes (see `12-history-undo/01-event-log.md` for retention).
...
- `01-information-architecture/01-hierarchy.md §3.5` — soft-delete rules.
- `12-history-undo/02-undo-redo.md` — Undo/Redo stack mechanics.
- `12-history-undo/01-event-log.md` — retention.
- `05-web-app/09-trash.md` — Trash UI.
- `06-ui-ux/11-feedback.md` — toast pattern.
- `19-security-privacy/04-gdpr-ccpa.md` — DSR override.
