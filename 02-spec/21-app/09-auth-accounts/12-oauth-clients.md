...
| preview | `https://*.ai-memory.app` | Preview branches (wildcard); Google requires explicit registration of each preview origin OR the use of `https://preview.letsmarknow.com` proxy |
