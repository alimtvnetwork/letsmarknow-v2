...
- If Org also deleted: 30-day soft-delete then hard delete (`09-auth-accounts/08-account-deletion.md` analogue at Org level).
...
- Used for revenue reporting (`11-revenue-reporting.md`).
