...
- Cancellation flow surfaces support before the final cancel button (see `13-cancellations-and-refunds.md`).
...
- Cancellation/refund flow: `13-cancellations-and-refunds.md`.
- Error reporting opt-in: `18-analytics-telemetry/02-error-reporting.md`.
- Privacy of ticket data: `19-security-privacy/02-data-handling.md`.
