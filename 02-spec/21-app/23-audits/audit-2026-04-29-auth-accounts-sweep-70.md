...
**Scope:** All 14 markdown files in `02-spec/21-app/09-auth-accounts/`, cross-checked against just-locked `19-security-privacy/03-encryption.md` (Session 67-69), `19-security-privacy/01-threat-model.md`, and `17-admin-org/03-roles.md` (role enum SoT).
