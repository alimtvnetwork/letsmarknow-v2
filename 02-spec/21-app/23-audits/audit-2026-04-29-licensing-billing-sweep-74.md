...
**Scope:** All 19 markdown files in `02-spec/21-app/10-licensing-billing/`, cross-checked against `02-data-model/10-license.md`, `03-api-endpoints/01-conventions.md` (money fields), and the just-locked `09-auth-accounts/01-identity-model.md` (AU8 — `Org.plan_id` denormalization rule).
