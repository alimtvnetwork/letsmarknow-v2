...
**Scope:** All 7 markdown files in `02-spec/21-app/19-security-privacy/`, cross-checked against `09-auth-accounts/03-passwords-and-mfa.md` (auth source of truth) and `08-sharing-collab/13-share-link.md`.
