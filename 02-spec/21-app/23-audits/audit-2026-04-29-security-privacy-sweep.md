...
**Scope:** All 8 files in `02-spec/21-app/19-security-privacy/` plus every cross-folder reference to sub-processors, infrastructure providers, and email vendors.
