...
closed-because: 9 of 9 findings drained — SH2/SH4/SH7 session 62; SH1/SH8 session 63; SH3/SH5 session 64; SH6/SH9 session 65.
...
**Scope:** All 15 markdown files + `permissions-matrix.json` in `02-spec/21-app/08-sharing-collab/`, cross-checked against `02-data-model/07-share.md` (v1 share schema), Core memory role enum, and W-4 channel-naming lock.
