...
audit-id: 114
scope: 02-spec/21-app/17-admin-org/
...
## Files touched
- `02-spec/21-app/17-admin-org/03-roles.md` (§9 error-code rewrite)
- `02-spec/21-app/17-admin-org/04-audit-log.md` (§2 ID example)
- `02-spec/21-app/17-admin-org/05-data-export-delete.md` (4 line edits across §1, §3)
