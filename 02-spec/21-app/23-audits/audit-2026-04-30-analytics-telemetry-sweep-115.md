...
audit-id: 115
scope: 02-spec/21-app/18-analytics-telemetry/
...
## Files touched
- `02-spec/21-app/18-analytics-telemetry/03-events.md` (added `analytics` domain to §1; added §2.16 with 8 new event rows)
- `02-spec/21-app/18-analytics-telemetry/01-opt-in-analytics.md` (§4, §6, §7, §12 rewritten as SoT-deferring sections)
- `02-spec/21-app/18-analytics-telemetry/02-error-reporting.md` (§12 rewritten as SoT-deferring section)
