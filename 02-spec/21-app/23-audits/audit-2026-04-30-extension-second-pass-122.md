...
**Date:** 2026-04-30
**Scope:** All 21 files in `02-spec/21-app/04-extension/` (2,441 lines). Second pass after audit-108. Checks: (a) endpoint canonicality, (b) sync param + error-code drift, (c) ULID/role/Workspace label leakage, (d) realtime SoT conformance.
...
- `grep -rnE 'org=<id>|since_etag|next_etag' 02-spec/21-app/04-extension/` → 0 matches.
