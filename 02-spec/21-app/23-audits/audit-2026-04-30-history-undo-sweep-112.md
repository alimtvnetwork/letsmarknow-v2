...
audit-id: 112
scope: 02-spec/21-app/12-history-undo/
...
## Files touched
- `02-spec/21-app/03-api-endpoints/18-error-codes.md` (+1 section, renumber)
- `02-spec/21-app/03-api-endpoints/14-history.md` (§undo error list rewrite)
- `02-spec/21-app/12-history-undo/02-undo-redo.md` (§8 table rewrite)
- `02-spec/21-app/12-history-undo/03-conflict-resolution.md` (§10 row)
