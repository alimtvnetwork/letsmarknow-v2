...
audit-id: 112
scope: 02-spec/21-app/11-import-export/
...
**Date:** 2026-04-30
**Scope:** `02-spec/21-app/11-import-export/` reconciled against `03-api-endpoints/15-import-export.md`, `03-api-endpoints/18-error-codes.md §3.7`, `03-api-endpoints/01-conventions.md`.
