...
audit-id: 111
scope: 02-spec/21-app/14-search/
...
**Date:** 2026-04-30
**Scope:** `02-spec/21-app/14-search/` reconciled against `03-api-endpoints/13-search.md`, `02-data-model/05-item.md`, `03-api-endpoints/01-conventions.md`, `07-features/13-command-palette.md`.
