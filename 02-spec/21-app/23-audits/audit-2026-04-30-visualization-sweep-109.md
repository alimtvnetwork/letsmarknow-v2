...
audit-id: 109
scope: 02-spec/21-app/15-visualization/
...
All 7 files in `02-spec/21-app/15-visualization/` plus their cross-folder dependencies (`07-features/08-view-modes.md`, `02-data-model/03-collection.md`, `03-api-endpoints/23-mindmap-layouts.md`).
