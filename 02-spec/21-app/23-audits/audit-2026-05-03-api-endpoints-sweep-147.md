...
**Scope:** `02-spec/21-app/03-api-endpoints/` — 24 files + `flow-diagram.mmd`.
...
- `02-spec/21-app/03-api-endpoints/15-import-export.md`
- `02-spec/21-app/13-spec-issues/02-current-issues.md` (SI-030 added)
- `02-spec/21-app/00-conversation-log.md`
- `02-spec/21-app/23-audits/audit-2026-05-03-api-endpoints-sweep-147.md` (new)
