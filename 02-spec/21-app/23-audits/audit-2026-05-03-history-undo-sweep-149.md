...
**Scope:** `02-spec/21-app/12-history-undo/` — 5 files (`00-overview.md`, `01-event-log.md`, `02-undo-redo.md`, `03-conflict-resolution.md`, `readme.md`) + `flow-diagram.mmd`. 615 lines total.
...
- `02-spec/21-app/23-audits/audit-2026-05-03-history-undo-sweep-149.md` (new)
