...
**Scope:** `02-spec/21-app/01-information-architecture/` — 4 files (`00-overview.md`, `01-hierarchy.md`, `readme.md`, `flow-diagram.mmd`).
...
- `02-spec/21-app/01-information-architecture/readme.md` (1 line)
- `02-spec/21-app/00-conversation-log.md` (append entry)
- `02-spec/21-app/23-audits/audit-2026-05-03-information-architecture-sweep-145.md` (new)
