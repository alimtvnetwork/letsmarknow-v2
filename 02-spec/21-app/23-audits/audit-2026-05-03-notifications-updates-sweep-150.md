...
**Scope:** `02-spec/21-app/16-notifications-updates/` — 5 files (433 lines) + `flow-diagram.mmd`.
...
- `02-spec/21-app/16-notifications-updates/01-in-app-updates-feed.md`
- `02-spec/21-app/00-conversation-log.md`
- `02-spec/21-app/23-audits/audit-2026-05-03-notifications-updates-sweep-150.md` (new)
