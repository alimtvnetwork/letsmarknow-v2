...
**Scope:** 14 numbered markdown files + `flow-diagram.mmd` + `permissions-matrix.json` + `readme.md` + `url-normalization.md` in `02-spec/21-app/08-sharing-collab/`. First broad sweep (folder previously touched only narrowly during S117 invite-share parity).
