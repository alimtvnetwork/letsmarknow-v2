...
**Scope:** `02-spec/21-app/08-sharing-collab/` — 17 files (`00-overview.md`, `01-share-model.md` … `14-realtime-transport.md`, `url-normalization.md`, `permissions-matrix.json`, `readme.md`) + `flow-diagram.mmd`.
...
- `02-spec/21-app/23-audits/audit-2026-05-03-sharing-collab-sweep-152.md` (new)
