...
**Scope:** `02-spec/21-app/06-ui-ux/` — 23 files + `wireframes/` + `flow-diagram.mmd`.
...
- `02-spec/21-app/06-ui-ux/17-copy-strings.md`
- `02-spec/21-app/00-conversation-log.md`
- `02-spec/21-app/23-audits/audit-2026-05-03-ui-ux-sweep-146.md` (new)
