...
4. **F-4 fix** — write `02-spec/21-app/25-references/00-overview.md` (template at `templates/folder-overview.md`). (S2, 5 min)
...
- **Created:** `02-spec/21-app/23-audits/audit-2026-05-06-ai-readiness-score-v3.md` (this file).
