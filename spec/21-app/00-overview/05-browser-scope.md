...
### 2.2 Onboarding (`05-web-app/04-onboarding.md`, wireframes)
...
### 2.3 Marketing site (`05-web-app/13-marketing-site.md`)
...
### 2.6 Embed widget (`08-sharing-collab/10-embed-widget.md`)
...
### 2.9 Print stylesheet (`06-ui-ux/16-print-stylesheet.md`)
- v1 print QA: Chrome only. Safari `@page` notes remain documentary, not blocking.

### 2.10 Audit log (`17-admin-org/04-audit-log.md`)
...
- `00-overview/01-vision.md` — already correctly marks Firefox/Safari as "Chrome-first, then Chromium siblings, then Firefox"; v1 implementation **stops at Chrome**.
- `00-overview/04-competitive-analysis.md` — Firefox row stays as "⏭ later phase".
...
- `05-web-app/04-onboarding.md` — only the Chrome CTA renders in v1.
- `05-web-app/15-pwa.md` — QA matrix reduces to Chrome rows for v1.
- `06-ui-ux/16-print-stylesheet.md` — Chrome-only QA in v1.
- `06-ui-ux/wireframes/04-onboarding.md` — Step 2 renders only the Chrome install card in v1.
- `07-features/14-extensions-os-integrations.md` — non-Chrome rows in browser table are **postponed**.
- `08-sharing-collab/10-embed-widget.md` — cross-browser iframe QA reduces to Chrome.
- `11-import-export/01-formats.md` — bookmark HTML uploads from any browser remain supported.
- `11-import-export/02-importers.md` — only the **Chrome** row uses extension auto-pull in v1; all others are HTML upload only.
- `11-import-export/10-migration-out.md` — export to Netscape HTML stays universal.
- `16-notifications-updates/02-app-updater.md` — only the "Chrome Web Store" path is implemented in v1.
- `17-admin-org/04-audit-log.md` — `Mozilla/5.0` is a UA string, **not** a browser-target reference. No change.
- `20-roadmap/02-phase-1-v1.md` — non-goals already exclude Firefox/Safari/Edge correctly.
- `20-roadmap/04-phase-3-mindmap-ai.md` — non-goals already exclude cross-browser correctly.
- `20-roadmap/05-phase-4-cross-browser.md` — the single home for all postponed browser work.
