...
| Free tier item cap | 60 saved tabs | 8 categories | TBD — see `10-licensing-billing/plans-matrix.md` |
...
Marketing site (`05-web-app/marketing-site.md`) leads with this exact positioning. Comparison page (`/vs/toby`, `/vs/tabextend`) reproduces a public version of this matrix.
