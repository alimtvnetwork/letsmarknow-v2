...
- **Has:** ShareView records (separate analytics entity, see `08-sharing-collab/share-analytics.md`).
...
## Public viewer behavior (summary — full spec in `05-web-app/share-viewer.md`)
