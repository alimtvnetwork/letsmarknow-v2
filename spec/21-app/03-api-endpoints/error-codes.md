...
>
> **Closes:** Blocker B2 from `gap-analysis.md`.

---

## 1. Error envelope (recap from `conventions.md`)
...
- `message` — human-readable, English only. Frontend may override with `copy-strings.md` key `error.<code>`.
...
2. Add the toast key to `06-ui-ux/copy-strings.md` under `errors.*`.
