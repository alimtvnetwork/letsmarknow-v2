...
| Offline | Save queued (see `sync-and-offline.md`). Notification reflects queued state. |
...
`title` strings come from `_locale/<locale>/messages.json` via `chrome.i18n.getMessage("ctxSavePage")`. See `17-i18n-a11y/extension-strings.md`.
