...
- **Spec:** sub-section of `popup.md` (shares 80% UI with popup).
...
- **Spec:** `context-menu.md`

## 7. Keyboard Shortcuts (`commands`)
- See `keyboard-shortcuts.md` and the `commands` block in `manifest.md`.
...
- Not a "surface" but the runtime that wires all of the above. See `service-worker.md`.
