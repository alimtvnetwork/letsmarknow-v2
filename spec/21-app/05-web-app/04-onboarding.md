...
- **v1 (Chrome-only):** No per-browser CTAs for Edge/Brave/Firefox. Single line: "Coming soon for Edge, Brave, Arc, Firefox, and Safari." See `00-overview/05-browser-scope.md`.
