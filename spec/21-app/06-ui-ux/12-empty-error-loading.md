...
- Animate via `shimmer` keyframe (see `07-motion.md`).
...
See `11-feedback.md` and `10-forms.md`.
...
- Mutations queued (see `04-extension/10-sync-and-offline.md` for shared logic).
