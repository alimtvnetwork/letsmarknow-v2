...
>
> **Voice & tone:** see `copy-voice.md`. This file is the *content*; that file is the *style*.
...
## 14. Toast messages (`toast.*`) — used by `error-codes.md`
...
- **All toast messages** map 1:1 to an `error_code` in `error-codes.md` or to a system event.
