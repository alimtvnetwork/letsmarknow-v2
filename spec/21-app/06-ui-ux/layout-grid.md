...
Three density modes affect padding, row height, and font size on data-heavy surfaces (members table, items list, activity feed). See `data-density.md`.
...
- Single column; max width 640 px; no shell chrome; see `print-stylesheet.md`.
