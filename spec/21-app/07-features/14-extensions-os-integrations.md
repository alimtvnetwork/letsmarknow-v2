...
- Manifest declares `share_target` (see `05-web-app/15-pwa.md`).
...
> **v1 scope (LOCKED):** Only the Chrome row ships in v1. All other rows are **postponed to Phase 4**. See `00-overview/05-browser-scope.md`.
