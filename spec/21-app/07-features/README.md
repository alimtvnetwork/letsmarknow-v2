...
This folder catalogs every user-facing feature in v1, with rules, edge cases, and entitlement gating. Anything mentioned in `00-overview/vision.md` becomes a file here.
...
1. `save-tab.md` — single-tab save (the primary action).
2. `save-session.md` — multi-tab "save this window".
3. `quick-find.md` — Cmd+K / omnibox / popup search.
...
7. `notes-and-descriptions.md` — Markdown-lite content fields.
8. `view-modes.md` — grid / list / compact / column behavior.
9. `hover-to-jump.md` — switch to existing tab on hover.
10. `bulk-operations.md` — multi-select + actions.
11. `starring-and-pinning.md` — favorites and pinned positions.
12. `embeds-and-previews.md` — Pro+ rich previews.
13. `command-palette.md` — Cmd+K registry + extensibility.
14. `extensions-os-integrations.md` — share-target, protocol handler, OS sheets.
15. `feature-flags-and-rollouts.md` — gradual feature exposure.

## Files

| File | Purpose |
|---|---|
| `save-tab.md` | Save 1 tab |
| `save-session.md` | Save N tabs |
| `quick-find.md` | Search across saves |
| `collections.md` | Collection lifecycle |
| `groups.md` | Group lifecycle |
| `tags.md` | Tag lifecycle |
| `notes-and-descriptions.md` | Content fields |
| `view-modes.md` | Display modes |
| `hover-to-jump.md` | Open-tab detection |
| `bulk-operations.md` | Multi-select actions |
| `starring-and-pinning.md` | Favorites |
| `embeds-and-previews.md` | Rich previews |
| `command-palette.md` | Cmd+K |
| `extensions-os-integrations.md` | OS-level hooks |
| `feature-flags-and-rollouts.md` | Rollout system |
