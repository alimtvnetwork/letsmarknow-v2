...
> 📌 **Pointer file.** The shipping v1 share contract is `02-data-model/share.md`. The richer multi-link v2 design is in `08-sharing-collab/share-model.md` (marked v2-future).
...
Gated by License entitlement `custom_share_slug` (Pro+, see `10-licensing-billing/plans-matrix.md` and `entitlements-engine.md`). Free users get only auto-generated slugs.

## 5. SEO / indexability

- Default response headers: `X-Robots-Tag: noindex, nofollow`.
- Pro+ owners can flip per Share → `index, follow` and supply OG title/description/image (see `02-data-model/share.md`).
...
- Data contract: `02-data-model/share.md`.
- v2 multi-link future: `08-sharing-collab/share-model.md`.
- Security (entropy, enumeration): `19-security-privacy/share-link-security.md`.
- Public viewer: `05-web-app/share-viewer.md`.
