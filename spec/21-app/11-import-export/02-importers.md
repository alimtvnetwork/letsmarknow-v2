...
> **v1 scope (LOCKED):** Browser-extension auto-pull works in **Chrome only**. Bookmark **HTML file uploads** from any browser remain supported (uploading a file is browser-agnostic). See `00-overview/05-browser-scope.md`.
...
- Field mapping in `01-formats.md`.
...
- Our native format (`01-formats.md` § 3).
