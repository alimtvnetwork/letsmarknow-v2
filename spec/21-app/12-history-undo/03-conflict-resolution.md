...
- Mutations published as events (per `01-event-log.md`).
...
- Awareness layer (cursor, selection) overlaid (per `08-sharing-collab/06-realtime-presence.md`).
...
Per `04-extension/10-sync-and-offline.md`:
