...
| SI-020c | S1 | 15 endpoints genuinely missing — need new declared rows | **Phase 13.7a-d (DONE):** 9/24 declared: `GET /v1/auth/verify`, `PATCH /v1/account/preferences`, `POST /v1/me/gdpr-export`, `GET /v1/items/:id/history`, `GET /v1/public/shares/:slug/items`, `POST /v1/public/shares/:slug/comments`, `POST /v1/shares/:id/purge`, `POST /v1/shares/links/:id/revoke`, `POST /v1/public/shares/:slug/unlock` (already existed; reclaimed via §16 for the `shares/access` alias). New file: `19-account.md`. §16 alias table extended with 3 new mappings (share-public→public/shares, comment→comments, /shares/access→/public/shares/:slug/unlock); §16.3 grep extended; 4 referencing files swept (`09-auth-accounts/11-rate-limits-and-abuse.md`, `09-auth-accounts/13-rate-limit-values.md`, `08-sharing-collab/03-password-shares.md`, `22-infrastructure/06-cdn-storage.md`). **Still missing (15):** `DELETE /v1/mindmap-layouts/:id`, `GET /v1/billing/invoices/:id/pdf`, `GET /v1/exports/lmn-json/:account_token`, `GET /v1/imports/:id/preview`, `GET /v1/imports/:id/status`, `GET /v1/jobs/:job_id`, `GET /v1/organizations/:id/data-export/:export_id`, `POST /v1/exports/:export_id/refresh-url`, `POST /v1/flags/evaluate`, `POST /v1/imports/:id/commit`, `POST /v1/imports/upload`, `POST /v1/internal/feedback`, `POST /v1/mindmap-layouts`, `POST /v1/webhooks/email-in`, `POST /v1/webhooks/inbound/:webhook_token`. | Continue: 13.7e Imports/Exports (6) → 13.7f Billing+Org (2) → 13.7g New domains (Jobs, Flags, Internal, Webhooks, Mindmap-layouts — 7 endpoints, may need new files). | §1, §3 |
