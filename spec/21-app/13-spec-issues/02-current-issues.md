...
| SI-026 | S3 | 🟡 open 2026-04-29 Session 38 — Forward-ref backlog: **7 backticked-path refs remaining** (was 21 at S38; S39:6, S41:2, S44:1, S45:2, S46:2, S47:1 by authoring `10-licensing-billing/16-billing-emails.md` — file slot 16 chosen because 07 was occupied by `07-seats-and-quotas.md`; citing ref in `03-api-endpoints/17-billing-webhooks.md:345` rewritten to NN- path). Remaining planned files (paths shown plainly): "17-i18n-a11y/extension-strings.md", "08-sharing-collab/share-model.md" (v2), and "payments-integration.md", plus duplicate citations from different source files. All current allowlist entries live in `scripts/lint/backticked-path-resolution.allowlist.txt` with `PR:#0 reason:SI-026 — ...` per entry. Closure = author each planned file (or convert refs to plain prose). | `scripts/lint/backticked-path-resolution.allowlist.txt` | `scripts/lint/backticked-path-resolution.ts` registered in `22-infrastructure/09-ci-cd.md §2.1.1` | n/a (forward-ref pattern) | (was 21 at S38; S39 closed 6; S41 closed 2; S44 closed 1; S45 closed 2; S46 closed 2 by authoring `07-features/18-add-item-hover-button.md` and renaming the 2 citing refs in `00-overview/04-competitive-analysis.md` and `readme.md` to NN- prefixed paths). Remaining planned files (paths shown plainly): "17-i18n-a11y/extension-strings.md", "08-sharing-collab/share-model.md" (v2), "10-licensing-billing/07-billing-emails.md", and "payments-integration.md", plus duplicate citations from different source files. All current allowlist entries live in `scripts/lint/backticked-path-resolution.allowlist.txt` with `PR:#0 reason:SI-026 — ...` per entry. Closure = author each planned file (or convert refs to plain prose). | `scripts/lint/backticked-path-resolution.allowlist.txt` | `scripts/lint/backticked-path-resolution.ts` registered in `22-infrastructure/09-ci-cd.md §2.1.1` | n/a (forward-ref pattern) | (was 21 at S38; S39 closed 6; S41 closed 2; S44 closed 1; S45 closed 2 by authoring `06-ui-ux/21-options-page.md` and `06-ui-ux/22-keyboard-cheatsheet.md`, citing refs in `04-extension/02-surfaces.md` and `04-extension/08-keyboard-shortcuts.md` updated to NN- prefixed paths). Remaining planned files (paths shown plainly): "17-i18n-a11y/extension-strings.md", "08-sharing-collab/share-model.md" (v2), "07-features/add-item-hover-button.md", "10-licensing-billing/07-billing-emails.md", and "payments-integration.md", plus duplicate citations from different source files. All current allowlist entries live in `scripts/lint/backticked-path-resolution.allowlist.txt` with `PR:#0 reason:SI-026 — ...` per entry. Closure = author each planned file (or convert refs to plain prose). | `scripts/lint/backticked-path-resolution.allowlist.txt` | `scripts/lint/backticked-path-resolution.ts` registered in `22-infrastructure/09-ci-cd.md §2.1.1` | n/a (forward-ref pattern) | (was 21 at S38 open; S39 closed 6 by qualifying phase-roadmap paths and authoring 3 release-ops stubs in `04-extension/`; S41 closed 2 by authoring `19-security-privacy/06-extension-privacy.md` and `19-security-privacy/07-privacy-policy.md`; S44 closed 1 by authoring `08-sharing-collab/url-normalization.md`). Remaining planned files (paths shown plainly to avoid linter recursion): "06-ui-ux/options-page.md", "06-ui-ux/keyboard-cheatsheet.md", "17-i18n-a11y/extension-strings.md", "08-sharing-collab/share-model.md" (v2), "07-features/add-item-hover-button.md", "10-licensing-billing/07-billing-emails.md", and "payments-integration.md", plus duplicate citations from different source files. All current allowlist entries live in `scripts/lint/backticked-path-resolution.allowlist.txt` with `PR:#0 reason:SI-026 — ...` per entry. Closure = author each planned file (or convert refs to plain prose). | `scripts/lint/backticked-path-resolution.allowlist.txt` | `scripts/lint/backticked-path-resolution.ts` registered in `22-infrastructure/09-ci-cd.md §2.1.1` | n/a (forward-ref pattern) | (was 21 at S38 open; S39 closed 6 by qualifying phase-roadmap paths and authoring 3 release-ops stubs in `04-extension/`; S41 closed 2 more by authoring `19-security-privacy/06-extension-privacy.md` and `19-security-privacy/07-privacy-policy.md`). Remaining planned files (paths shown plainly to avoid linter recursion): "06-ui-ux/options-page.md", "06-ui-ux/keyboard-cheatsheet.md", "17-i18n-a11y/extension-strings.md", "08-sharing-collab/share-model.md" (v2), "08-sharing-collab/url-normalization.md", "07-features/add-item-hover-button.md", "10-licensing-billing/07-billing-emails.md", and "payments-integration.md", plus duplicate citations from different source files. All current allowlist entries live in `scripts/lint/backticked-path-resolution.allowlist.txt` with `PR:#0 reason:SI-026 — ...` per entry. Closure = author each planned file (or convert refs to plain prose). | `scripts/lint/backticked-path-resolution.allowlist.txt` | `scripts/lint/backticked-path-resolution.ts` registered in `22-infrastructure/09-ci-cd.md §2.1.1` | n/a (forward-ref pattern) |
