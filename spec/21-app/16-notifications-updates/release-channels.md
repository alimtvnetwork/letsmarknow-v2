...
- Spec'd in `07-features/feature-flags-and-rollouts.md`.
...
| High (data model change) | 100% beta for 1 month + small stable cohort (1%) | Phased rollout per `feature-flags-and-rollouts.md` |
