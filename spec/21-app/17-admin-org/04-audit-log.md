...
- Up to 100k rows per export; larger requests queued via `05-data-export-delete.md`.
...
- Spec'd in `08-sharing-collab/09-audit-log.md` for the cross-cutting events (share-related).
