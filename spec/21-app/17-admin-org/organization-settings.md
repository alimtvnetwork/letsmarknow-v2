...
- **Restrict to stable channel** (per `release-channels.md`).
...
- Webhook outbox: HTTPS endpoint + secret for events (per `08-sharing-collab/audit-log.md`).
...
- "Transfer ownership" → opens flow (per `members-management.md` § 7).
- "Export all Org data" → `data-export-delete.md`.
- "Delete this Org" → `data-export-delete.md`.
