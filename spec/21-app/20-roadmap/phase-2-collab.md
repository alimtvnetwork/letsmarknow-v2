...
- **Roles**: Owner, Admin, Editor, Viewer (per `roles.md`).
...
- **Conflict resolution**: per `12-history-undo/conflict-resolution.md` (CRDTs for notes; LWW for scalars).
...
- **Real-time transport**: WebSocket fleet (or SSE) per `08-sharing-collab/realtime-presence.md`.
