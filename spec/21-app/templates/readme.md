...
- When a template changes (e.g. new required section), bump the linter assertion and the audit tracker (`audit-2026-04-19-ai-readiness-score.md`) in the same PR.
